<?php 
    ...
    $ProtectedArea_Data=mysqli_query($con, "select * from sys_areas_protegidas");
    $ProjectData=mysqli_query($con, "select * from project");
    $afiliados_adherentes_Data=mysqli_query($con, "select * from sys_afiliados_adherentes");
    $afiliados_Data=mysqli_query($con, "select * from sys_afiliados");
                ...
                <div class="row top_tiles">
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <div class="count"><?php echo mysqli_num_rows($ProtectedArea_Data) ?></div>
                    ...
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          ...
                          <div class="count"><?php echo mysqli_num_rows($afiliados_adherentes_Data) ?></div>
                          <h3>AFILIADOS ADHERENTES</h3>
                        </div>
                    </div>
                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="tile-stats">
                          <div class="icon"><i class="fa fa-th-list"></i></div>
                          <div class="count"><?php echo mysqli_num_rows($afiliados_Data) ?></div>
